 ...
 */
final class Version20221127164957 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, supplier_id INT DEFAULT NULL, description VARCHAR(150) DEFAULT NULL, price NUMERIC(10, 2) NOT NULL, discount NUMERIC(3, 2) DEFAULT NULL, stock INT DEFAULT NULL, reference VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
